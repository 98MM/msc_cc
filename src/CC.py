...
class CategoricalClassification:
    ...
    def generate_nonlinear_labels(self, X, n=2, p=0.5, k=2, decision_function=None):

        """
        Generates labels for dataset X, nonlinear relationship with samples
    ...
    def generate_linear_labels(self, X, n=2, p=0.5, k=2, decision_function=None):
        """
        Generates labels for dataset X, linear relationship with samples
        :param X: dataset
        :param n: number of class labels
        :param p: class distribution
        :param k: constant
